...
@Component({
  selector: 'app-sales-showroom',
  templateUrl: './sales-showroom.component.html',
  styleUrls: ['./sales-showroom.component.scss']
})
export class SalesShowroomComponent implements OnInit {
  ...
  getItemWiseData(){ 
    this.service.getShowroomItemwiseSales(this.curYear.toString()).subscribe((response : any) => {
      this.curYearItemWiseRprt = response.recordset;
    });
    this.service.getShowroomItemwiseSales(this.preYear.toString()).subscribe((response : any) => {
  ...
  getMonthWiseData() {
    var i: number;
    this.service.getMonthwiseShowroomSales(this.curYear.toString()).subscribe((response : any) => {
      this.curYearMonthRprt = response.recordset;
    });
    this.service.getMonthwiseShowroomSales(this.preYear.toString()).subscribe((response : any) => {
  ...
  getDayWiseData(date: string) {
    ...
    this.gotError = false;
    this.service.getDaywiseShowroomSales(this.dataDate).subscribe((response : any) => {
